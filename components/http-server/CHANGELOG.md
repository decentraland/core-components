...
- b426dd3: Accumulate `Vary` in the CORS middleware instead of overwriting it, so a shared cache can no longer serve a preflight built for one origin to another.
